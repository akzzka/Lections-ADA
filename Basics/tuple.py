"===========================Tuple=============================="
# Кортеж(tuple) - неизменяемый, индексируемый, упорядоченны, итерируемый тип данных,
# предназначенный для хранения любых данных в определенном порядке 
# (в целом не отличается от списков, просто он не изменяемый, поэтому занимает меньше памяти)
